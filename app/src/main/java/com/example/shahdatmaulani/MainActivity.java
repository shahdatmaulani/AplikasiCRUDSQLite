...
public class MainActivity extends AppCompatActivity {
        ...
        btnCreate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!input.getText().toString().isEmpty()) {
                    ...
                    Toast.makeText(MainActivity.this, "Kolom Input Nama Tidak Boleh Kosong", Toast.LENGTH_LONG).show();
                }
            }
        });
    ...
    private boolean validasi(boolean isDelete) {
        ...
        if (txtInput.isEmpty()) {
            Toast.makeText(this, "Kolom Input Nama Tidak Boleh Kosong", Toast.LENGTH_LONG).show();
            return false;
        }
        if (!isDelete && txtUpdateDelete.isEmpty()) {
            Toast.makeText(this, "Kolom Update Nama Tidak Boleh Kosong", Toast.LENGTH_LONG).show();
            return false;
        }

        //nilai input harus ada di database sebelumnya
        if (!crud.getDataByInput(txtInput)) {
            Toast.makeText(this, "Nama yang Anda Input Tidak Ditemukan Didatabase", Toast.LENGTH_LONG).show();
            return false;
        }
